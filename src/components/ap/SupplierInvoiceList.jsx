...
export default function SupplierInvoiceList({ invoices, isLoading, onEdit }) {
  const statusColors = {
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                ...
                {invoice.invoice_number && (
                  <p className="text-sm text-stone-600">Invoice #{invoice.invoice_number}</p>
                )}
            ...
            <div className="flex items-center justify-between pt-4 border-t border-stone-100">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-stone-700">{invoice.items?.length || 0}</p>
                </div>
              </div>
              <Button
                variant="outline"
