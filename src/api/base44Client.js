...
export const base44 = {
  entities: {
    ...
    StaffingAgency:             createEntity('StaffingAgency'),
    AgencyWorker:               createEntity('AgencyWorker'),
    StaffingRule:               createEntity('StaffingRule'),
    EventStaffingPlan:          createEntity('EventStaffingPlan'),
    EventAgencySplit:           createEntity('EventAgencySplit'),
    EventShift:                 createEntity('EventShift'),
    TipPool:                    createEntity('TipPool'),
    ...
    FixedExpense:               createEntity('FixedExpense'),
    Event_GeneralExpense:       createEntity('Event_GeneralExpense'),
